          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-2 text-gray-300 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+2348138461999" className="hover:text-ivory-gold transition-colors">+234 813 846 1999</a>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex space-x-3">
                <a href="https://www.facebook.com/share/15y5a4wA4b/" target="_blank" rel="noopener noreferrer" aria-label="Visit Ceetech Crafts on Facebook" title="Visit Ceetech Crafts on Facebook" className="bg-white/10 p-2 rounded-lg hover:bg-ivory-gold hover:text-charcoal transition-all duration-300">
                  <Facebook className="w-4 h-4" />
                </a>
                <a href="https://www.instagram.com/ceetech_official?igsh=d3pkdHdxbHNma3pu" target="_blank" rel="noopener noreferrer" aria-label="Visit Ceetech Crafts on Instagram" title="Visit Ceetech Crafts on Instagram" className="bg-white/10 p-2 rounded-lg hover:bg-ivory-gold hover:text-charcoal transition-all duration-300">
                  <Instagram className="w-4 h-4" />
                </a>
                <a href="https://tiktok.com/@ctechfurniture.interior" target="_blank" rel="noopener noreferrer" aria-label="Visit Ceetech Crafts on TikTok" title="Visit Ceetech Crafts on TikTok" className="bg-white/10 p-2 rounded-lg hover:bg-ivory-gold hover:text-charcoal transition-all duration-300">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/>
                  </svg>
                </a>
                <a href="https://wa.me/2348138461999" target="_blank" rel="noopener noreferrer" aria-label="Chat with Ceetech Crafts on WhatsApp" title="Chat with Ceetech Crafts on WhatsApp" className="bg-white/10 p-2 rounded-lg hover:bg-ivory-gold hover:text-charcoal transition-all duration-300">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
