          ...
          <div>
            ...
            <div>
              ...
              <div className="flex space-x-3">
                ...
                <a href="https://wa.me/2349069616141" target="_blank" rel="noopener noreferrer" className="bg-white/10 p-2 rounded-lg hover:bg-light-tan hover:text-dark-brown transition-all duration-300">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
