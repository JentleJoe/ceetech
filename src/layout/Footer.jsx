      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="border-t border-white/10 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-gray-400 text-xs">
              <span>Made in Benin City, Nigeria</span>
              <span>•</span>
              <a href="/contact" className="hover:text-light-tan transition-colors">Need Help? Contact Us</a>
            </div>
          </div>
        </div>
      </div>
