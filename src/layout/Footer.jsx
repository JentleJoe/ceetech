          ...
          <div>
            ...
            <div>
              ...
              <div className="flex space-x-3">
                ...
                <a href="https://wa.me/2348138461999" target="_blank" rel="noopener noreferrer" className="bg-white/10 p-2 rounded-lg hover:bg-ivory-gold hover:text-charcoal transition-all duration-300">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
