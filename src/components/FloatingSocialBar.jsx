...
const FloatingSocialBar = () => {
  return (
    <div className="hidden lg:block fixed right-6 top-1/2 -translate-y-1/2 z-50">
      <div className="flex flex-col space-y-3 bg-jet-black/80 backdrop-blur-sm p-3 rounded-2xl shadow-2xl border border-white/10">
        <a 
        ...
        >
          <svg className="w-5 h-5 text-white group-hover:text-charcoal" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center">
          <span className="text-[10px] text-white/50 font-light tracking-wider transform -rotate-90 inline-block whitespace-nowrap">
            FOLLOW
          </span>
        </div>
      </div>
