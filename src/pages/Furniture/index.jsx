              ...
              <div key={index} className={`grid lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                ...
                <div className={`${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                  <div className="bg-white rounded-xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="">
                      <a href="/contact" className="inline-block bg-charcoal text-ivory-gold px-8 py-3 rounded-lg font-semibold hover:scale-105 transition-transform duration-200 w-full sm:w-auto text-center">
                        Free Consultation
                      </a>
                    </div>
                  </div>
            ...
            {householdFurniture.map((category, index) => (
              <div key={index} className="group">
                ...
                <div className="bg-ivory-gold rounded-xl p-6 hover:bg-soft-gold transition-colors duration-300 group-hover:shadow-lg border border-ivory-gold/20">
                  ...
                  <div className="">
                    <a href="/contact" className="block w-full bg-charcoal text-ivory-gold px-6 py-3 rounded-lg font-semibold hover:scale-105 transition-transform duration-200 text-center">
                      Free Consultation
                    </a>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/contact"
                className="bg-ivory-gold text-charcoal px-8 py-3 rounded-lg text-lg font-semibold hover:scale-105 transition-transform duration-200 flex items-center justify-center space-x-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                </svg>
