          ...
          <div id="locations" className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600 mb-6 leading-relaxed">2 Evbuabogun road, Sapele Rd, Benin City</p>
                  <a
                    href="https://maps.google.com/?q=2+Evbuabogun+road+Sapele+Rd+Benin+City"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center space-x-1 bg-gray-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-700 transition-colors duration-200"
                  >
            ...
            <div className="bg-warm-brown/10 border border-warm-brown/20 rounded-xl p-6 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a
                  href="https://wa.me/2349069616141?text=Hello%20Ceetech%20Crafts%2C%20I%27d%20like%20to%20visit%20your%20main%20showroom"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="p-8 pb-0">
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="text-center bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-xs text-gray-600">+234 906 961 6141</p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <PhoneCall className="w-5 h-5" />
                <span>Call: +234 906 961 6141</span>
              </a>
              <a
                href="https://wa.me/2349069616141?text=Hello%20Ceetech%20Crafts%2C%20I%27m%20interested%20in%20your%20services"
                target="_blank"
