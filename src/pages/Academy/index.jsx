        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <a 
              ...
              className="bg-ivory-gold text-charcoal px-8 py-3 rounded-lg text-lg font-semibold hover:bg-opacity-90 hover:shadow-2xl hover:scale-105 transition-all duration-200 shadow-lg inline-flex items-center space-x-2"
            >
          ...
          <div className="max-w-7xl mx-auto">
              ...
              {programs.map((program, index) => (
                <div key={index} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                  ...
                  <div className={`p-6 text-center ${index === 0 ? 'bg-gradient-to-br from-green-50 to-green-100' : 'bg-gradient-to-br from-amber-50 to-amber-100'}`}>
                    ...
                    <h3 className="text-2xl font-playfair text-dark-brown mb-2">{program.title}</h3>
                    <p className="text-warm-brown font-semibold mb-3">{program.subtitle}</p>
                    <div className="flex items-center justify-center text-dark-brown/70 mb-2">
                  ...
                  {/* Program Content */}
                  <div className="p-6">
                    <p className="text-dark-brown/80 mb-6 leading-relaxed">{program.description}</p>
                    
                    {/* Curriculum Highlights */}
                    <div className="mb-6">
                      <h4 className="font-semibold text-dark-brown mb-4 flex items-center">
                        <BookOpen className="w-5 h-5 mr-2 text-warm-brown" />
                        Curriculum Highlights
                      </h4>
                      <div className="space-y-2">
                        {program.highlights.map((highlight, highlightIndex) => (
                          <div key={highlightIndex} className="flex items-start text-sm text-dark-brown/70">
                            <span className="w-2 h-2 bg-warm-brown rounded-full mr-3 mt-2 flex-shrink-0"></span>
                            <span>{highlight}</span>
                          </div>
                        ))}
                      </div>
                    ...
                    {/* Practical Projects */}
                    <div className="mb-6">
                      <h4 className="font-semibold text-dark-brown mb-3 flex items-center">
                        <Award className="w-5 h-5 mr-2 text-warm-brown" />
                        Practical Projects
                      </h4>
                      <div className="flex flex-wrap gap-2">
                        {program.projects.map((project, projectIndex) => (
                          <span key={projectIndex} className="bg-light-tan text-charcoal px-3 py-1 rounded-full text-xs font-medium">
                            {project}
                          </span>
                        ))}
                      </div>
                    ...
                    <div className="bg-cream p-4 rounded-lg mb-6">
                      <h4 className="font-semibold text-dark-brown mb-2 text-sm">Upon Completion:</h4>
                      <p className="text-warm-brown text-sm font-medium">{program.certification}</p>
                    </div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full bg-ivory-gold text-charcoal py-3 px-4 rounded-lg hover:bg-rich-gold hover:text-charcoal transition-colors duration-200 font-semibold flex items-center justify-center space-x-2"
                    >
            ...
            <div className="mt-16 bg-white rounded-2xl p-8 shadow-lg">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-playfair text-dark-brown mb-4">What Makes Our Academy Special?</h3>
                <p className="text-dark-brown/80 max-w-3xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-dark-brown mb-2">Factory-Based Learning</h4>
                  <p className="text-dark-brown/70 text-sm">Learn in our active production facility alongside experienced craftsmen</p>
                </div>
                <div className="text-center">
                  <div className="bg-light-tan w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-2xl">🔨</span>
                  </div>
                  <h4 className="font-semibold text-dark-brown mb-2">Hands-On Training</h4>
                  <p className="text-dark-brown/70 text-sm">80% practical work with professional-grade tools and equipment</p>
                </div>
                <div className="text-center">
                  <div className="bg-light-tan w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-2xl">👨‍🏫</span>
                  </div>
                  <h4 className="font-semibold text-dark-brown mb-2">Master Craftsmen</h4>
                  <p className="text-dark-brown/70 text-sm">Learn directly from our experienced furniture makers with years of expertise</p>
                </div>
              </div>
            </div>
          </div>
